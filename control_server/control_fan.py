...
def on_connect(client, userdata, flags, rc):
    client.subscribe([(MQTT_TOPIC_FAN_HUMIDITY, 0), (MQTT_TOPIC_FAN_SETTINGS, 0),(MQTT_TOPIC_LIGHT_LUX, 0), (MQTT_TOPIC_LIGHT_SETTINGS, 0), (MQTT_TOPIC_SPRAYER_HUMIDITY, 0), (MQTT_TOPIC_SPRAYER_SETTINGS, 0), (MQTT_TOPIC_SPRAYER_INCREASE, 0)])

def on_message(client, userdata, msg):
    global current_humidity, humidity_threshold, current_light, light_threshold, current_sprayer, sprayer_threshold, decreasing
